...
import Migration0031 from "./Migrations/031_Comms.ts";
import Migration0032 from "./Migrations/032_CompactProjectionThreadActivityPayloads.ts";
import Migration0033 from "./Migrations/033_ProjectionThreadIdentity.ts";
...
export const migrationEntries = [
  ...
  [31, "Comms", Migration0031],
  [32, "CompactProjectionThreadActivityPayloads", Migration0032],
  [33, "ProjectionThreadIdentity", Migration0033],
] as const;
